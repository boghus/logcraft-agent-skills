...
4. If logging is justified, apply the specialized LogCraft rules for frequency, sensitive output, runtime, and CI/CD context.
...
4. If logging is not justified, explain what makes it noise and what alternative, if any, would better serve the use case.
5. Apply specialized rules before finalizing the recommendation.
