...
- **The event is ordinary execution flow.** Avoid logs for routine method calls, branches, assignments, getters/setters, or successful steps that provide no additional diagnostic value.
